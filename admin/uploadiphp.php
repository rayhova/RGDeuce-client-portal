...
$uploadpath = "mockups/".$clientname."/internal/";
...
{
    $msg = "need an image";
    header("Location: internaladd.php ");
}
mysqli_query($conn, "INSERT INTO internal (clientname, image, date, description) VALUES ('$_POST[clientname]','$imgFullpath',now() ,'$_POST[internaldesc]')" );
