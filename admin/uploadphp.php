...
if (isset($_POST['submit'])) {
    ...
    if ((($_FILES["file"]["type"] == "image/png") || ($_FILES["file"]["type"] == "image/jpg") || ($_FILES["file"]["type"] == "image/jpeg")
            ) && ($_FILES["file"]["size"] < 1500000)//Approx. 1.5mb files can be uploaded.
...
$uploadpath = "mockups/".$clientname."/homepage/";
...
{
    $msg = "need an image";
    header("Location: homepageadd.php ");
}
mysqli_query($conn, "INSERT INTO homepage (clientname, image, date, description) VALUES ('$_POST[clientname]','$imgFullpath',now() ,'$_POST[homepagedesc]')" );
