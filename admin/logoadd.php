...
<H2>RGDeuce Client System - Logo Design</H2>



<FORM METHOD="POST" ACTION="logoadd.php" enctype="multipart/form-data" id="form" name="form">
<P><B>Client logo info...</B>
...
<P><B>Logo Description: </B><BR>
<TEXTAREA NAME="logodesc" COLS=80 ROWS=4><?php print $logodesc ?></TEXTAREA>
